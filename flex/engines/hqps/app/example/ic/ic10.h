 ...
 public:
  ...
  void Query(const GRAPH_INTERFACE& graph, int64_t ts, Decoder& input,
    ...
    label_id_t has_interest_in_label_id =
        graph.GetEdgeLabelId(SNBLabels::hasInterest_label);
    ...
    auto ctx9 = Engine::Sort(
        ...
        std::tuple{
            gs::OrderingPropPair<gs::SortOrder::DESC, INPUT_COL_ID(1), int32_t>(
    ...
    auto ctx11 = Engine::template Project<PROJ_TO_NEW>(
