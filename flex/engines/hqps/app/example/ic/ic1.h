...
class QueryIC1 {
 ...
 public:
  ...
  void Query(const GRAPH_INTERFACE& graph, int64_t ts, Decoder& input,
    ...
    label_id_t isLocatedIn_label_id =
        graph.GetEdgeLabelId(SNBLabels::isLocatedIn_label);
    label_id_t place_label_id = graph.GetVertexLabelId(SNBLabels::place_label);
    label_id_t workAt_label_id = graph.GetEdgeLabelId(SNBLabels::workAt_label);
    label_id_t studyAt_label_id =
        graph.GetEdgeLabelId(SNBLabels::studyAt_label);
    label_id_t org_label_id = graph.GetVertexLabelId(SNBLabels::org_label);
    ...
    auto ctx14 =
        Engine::template Join<INPUT_COL_ID(0), INPUT_COL_ID(1), INPUT_COL_ID(0),
                              INPUT_COL_ID(1), JoinKind::LeftOuterJoin>(
    ...
    auto ctx15 = Engine::template Project<false>(
        ...
        std::tuple{
            ...
            gs::make_mapper_with_variable<INPUT_COL_ID(1)>(
                gs::PropertySelector<grape::EmptyType>()),
            gs::make_mapper_with_expr<INPUT_COL_ID(2), INPUT_COL_ID(3),
                                      INPUT_COL_ID(2), INPUT_COL_ID(4)>(
    ...
    auto ctx16 = Engine::template GroupBy(
        ...
        std::tuple{GroupKey<INPUT_COL_ID(0), grape::EmptyType>(
                       gs::PropertySelector<grape::EmptyType>()),
                   GroupKey<INPUT_COL_ID(1), grape::EmptyType>(
                       gs::PropertySelector<grape::EmptyType>())},
        std::tuple{gs::make_aggregate_prop<gs::AggFunc::TO_LIST>(
            std::tuple{gs::PropertySelector<grape::EmptyType>()},
