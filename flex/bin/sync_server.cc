...
int main(int argc, char** argv) {
  ...
  hqps_server::CodegenProxy::get().Init(codegen_dir, codegen_bin, db_home);

  hqps_server::service::get().init(shard_num, http_port, false);
  hqps_server::service::get().run_and_wait_for_exit();
