 ...
 *
 */
public class LongDoubleMessageStoreWithCombiner implements
    MessageStore<LongWritable, DoubleWritable, Long> {

    private static Logger logger = LoggerFactory.getLogger(LongDoubleMessageStore.class);

    private SimpleFragment<?, Long, ?, ?> fragment;
    private ImmutableClassesGiraphConfiguration<? extends LongWritable, ? extends Writable, ? extends Writable> conf;
...
//    private Map<Long, List<Double>> messages;
    ...
    public LongDoubleMessageStoreWithCombiner(SimpleFragment fragment,
...
//        messages = new HashMap<Long,List<Double>>((int) fragment.getInnerVerticesNum());
    ...
    public void swap(MessageStore<LongWritable, DoubleWritable, Long> other) {
        if (other instanceof LongDoubleMessageStore) {
            LongDoubleMessageStoreWithCombiner longDoubleMessageStore = (LongDoubleMessageStoreWithCombiner) other;
