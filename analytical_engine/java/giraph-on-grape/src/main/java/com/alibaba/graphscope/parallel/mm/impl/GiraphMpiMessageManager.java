...
public class GiraphMpiMessageManager<
    ...
    public void sendMessageToAllEdges(Vertex<OID_T, VDATA_T, EDATA_T> vertex, OUT_MSG_T message) {
        ...
        //            GrapeAdjList<GS_VID_T,?> grapeAdjList = ((GrapeAdjListAdaptor<GS_VID_T, ?>)
        // adaptorAdjList).getAdjList();
        ...
        //        Iterator<? extends GrapeNbr<GS_VID_T, ?>> grapeNbrIterator =
        // grapeAdjList.locals().iterator();
        ...
        //            for (int i = 0; i < grapeSize; ++i){
        //                com.alibaba.graphscope.ds.Vertex<GS_VID_T> tmpVertex =
        // grapeNbr.neighbor();
        //                unused += (Long) tmpVertex.GetValue();
        //            }
        //            grapeNeighbor += System.nanoTime();
    ...
    public void finishMessageSending() {
        for (int i = 0; i < fragNum; ++i) {
            ...
            if (i == fragId) {
                ...
                logger.debug(
                        "[Finish msg] sending msg from {} -> {}, actual msg size {}",
                        fragId,
                        i,
                        cacheOut[i].bytesWriten() - SIZE_OF_LONG);
