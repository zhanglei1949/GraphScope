...
//        short data = UnsafeHolder.U.getShort(base + offset);
     ...
     * }</pre>
     * This method is suitable for reading the bytes written by the {@code writeShort} method of
     * interface {@code DataOutput}  if the argument to {@code writeShort} was intended to be a
     * value in the range {@code 0} through {@code 65535}.
     *
...
//        short data = UnsafeHolder.U.getShort(base + offset);
     ...
     * }</pre>
     * <p>
     * This method is suitable for reading bytes written by the {@code writeLong} method of
     * interface {@code DataOutput}.
     *
     ...
     * <p>
     * If the first byte of a group matches the bit pattern {@code 110xxxxx}, then the group
     ...
     * has been reached, the value <code>-1</code> is returned. This method blocks until input data
