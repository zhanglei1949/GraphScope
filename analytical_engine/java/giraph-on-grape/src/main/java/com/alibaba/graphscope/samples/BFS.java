...
public class BFS extends BasicComputation<
    IntWritable, IntWritable, FloatWritable, IntWritable> {
    private static Logger logger = LoggerFactory.getLogger(BFS.class);
    /** The start id */
    public static final LongConfOption SOURCE_ID =
        new LongConfOption("bfs.sourceId", 6,
     ...
     */
    @Override
    public void compute(Vertex<IntWritable, IntWritable, FloatWritable> vertex,
