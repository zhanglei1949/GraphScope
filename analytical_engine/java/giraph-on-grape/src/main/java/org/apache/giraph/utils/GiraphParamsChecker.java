...
public class GiraphParamsChecker {
    ...
    private static final String [] keys = {"input_format_class","output_format_class","app_class","input_vfile" ,"input_efile", "output_path",
    "aggregator_class","combiner_class","resolver_class"};

    public static void verifyClasses(String classPath, String classes) {
        URLClassLoader classLoader = new URLClassLoader(classPath2URLArray(classPath) , GiraphParamsChecker.class.getClassLoader());
