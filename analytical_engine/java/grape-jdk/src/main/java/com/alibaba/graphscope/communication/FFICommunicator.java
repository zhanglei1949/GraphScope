...
/**
 * The java wrapper for <a href="https://github.com/alibaba/libgrape-lite/blob/master/grape/communication/communicator.h">grape
...
public interface FFICommunicator extends FFIPointer {
    ...
    @FFINameAlias("Sum") <MSG_T> void sum(@FFIConst @CXXReference MSG_T msgIn,
        @CXXReference MSG_T msgOut);

    @FFINameAlias("Min") <MSG_T> void min(@FFIConst @CXXReference MSG_T msgIn,
        @CXXReference MSG_T msgOut);

    @FFINameAlias("Max") <MSG_T> void max(@FFIConst @CXXReference MSG_T msgIn,
        @CXXReference MSG_T msgOut);

    @FFINameAlias("SendTo") <MST_T> void sendTo(int dstFid, @FFIConst @CXXReference MST_T msgOut);

    @FFINameAlias("RecvFrom") <MSG_T> void receiveFrom(int srcFid, @CXXReference MSG_T msgIn);
}
