...
class ANNOTATION(actor : impl) executor : public hiactor::actor {
 public:
  ...
  seastar::future<admin_query_result> ANNOTATION(actor
                                                 : method)
      create_vertex(query_param&& param);

  seastar::future<admin_query_result> ANNOTATION(actor
                                                 : method)
      create_edge(query_param&& param);

  seastar::future<admin_query_result> ANNOTATION(actor
                                                 : method)
      delete_vertex(query_param&& param);

  seastar::future<admin_query_result> ANNOTATION(actor
                                                 : method)
      delete_edge(query_param&& param);

  seastar::future<admin_query_result> ANNOTATION(actor
                                                 : method)
      update_vertex(query_param&& param);

  seastar::future<admin_query_result> ANNOTATION(actor
                                                 : method)
      update_edge(query_param&& param);
